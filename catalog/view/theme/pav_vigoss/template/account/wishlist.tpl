      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
          <tr>
            ...
            <p>
              <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-sm btn-default"><i class="fa-fw fa fa-shopping-cart"></i></button>
            </p>
