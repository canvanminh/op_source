...
<div class="main-columns container space-20">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div class="style-panel">
      ...
      <div class="accordion collapse-right" id="accordion">
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
						...
						$('#collapse-shipping-method').parent().find('.panel-heading .panel-title').html('<a href="#collapse-shipping-method" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_shipping_method; ?>');
